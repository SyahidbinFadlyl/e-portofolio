...
const list_experience: Experience[] = [
    ...
    },
    {
        ...
        company: "Happy Homes",
        description: `Build and maintain internal CRM applications (front end & back end).\n\nCollaborate with designers, and project managers to implement best practices in accessibility and functionality.\n\nActively handle challenges in adapting application flows and features from legacy business processes to new ones, ensuring that changes do not create issues with existing data.`,
        skills: [
            "JavaScript",
            "TypeScript",
            "React",
